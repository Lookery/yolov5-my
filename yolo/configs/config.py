...
_dir = os.path.abspath(os.path.join(os.getcwd(), ".."))

parser = argparse.ArgumentParser()
parser.add_argument('--base_dir', type=str,
                    default=_dir, help='base path')
...
parser.add_argument('--yaml_dir', type=str, default='yolo/configs/yolo-l-mish.yaml', help='model.yaml path')
...
parser.add_argument('--init_learning_rate', type=float, default=2e-4)
...
parser.add_argument('--mosaic_data', type=bool, default=True, help='if mosaic data')
